...
/**
 * Simple demonstration of a MultiTenantCMSManager that divides a fixed thread budget equally among all registered CMSs.
 */
public class MultiTenantCMSManager {
    ...
    private final Set<ConcurrentMergeScheduler> schedulers = Collections.synchronizedSet(new HashSet<>());
